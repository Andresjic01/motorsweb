<?php
    ...
    // $descripcion=$_POST['descripcion'];
        ...
        if (strlen($nomProducto)>0 && strlen($proveedor) >0 && strlen($categoria)>0 && strlen($cantidad)>0 && strlen($precio)>0  ) {
            ...
            $result = $objConsultas -> insertarProducAdmin($nomProducto,$proveedor,$categoria,$cantidad,$precio, $foto1, $foto2, $foto3, $foto4, $infovendedor);
