					...
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								...
								<li>
                                    <span  data-bs-toggle="modal" data-bs-target="#'.$f['Identificacion'].'">
			                            <i class="fi fi-ss-info"></i>
                                    </span>
								</li>
								<li>
...
function modalInfoTaller(){
    ...
    echo '
    <div class="modal product-modal" id="'.$f['Identificacion'].'" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1" >
  				<div class="modal-dialog modal-dialog-centered" style="max-width: 1200px; max-height: 900px;"  >
    				<div class="modal-content " >
