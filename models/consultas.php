...
<?php
    ...
    class Consultas{
        ...
        //Registrar una Cita 
        public function insertarCitaCliente($fecha, $hora,$Nservicio,$Ncliente, $Ntaller, $estado, $descripcion){
            $objConexion = new Conexion();
            $conexion = $objConexion-> get_conexion();

            $registrar = "INSERT INTO citas (Cliente, Taller, Fecha, hora, Servicio, EstadoCita, Descripcion ) values(:Ncliente, :Ntaller, :fecha, :hora, :Nservicio, :estado, :descripcion)";
        ...
        //mostrar los talleres a los clientes
        public function mostrarTalleresCliente(){
            ...
            $buscar = "SELECT * FROM usuarios where Rol= 'Vendedor'";
            $result = $conexion -> prepare ($buscar);
