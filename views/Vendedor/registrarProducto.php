                                ...
                                <div class='card-body'>
                                    <div class='basic-elements'>
                                        <form class='text-left clearfix'
                                            action='../../controllers/registrarProductosVendedor.php' method='POST'
                                            enctype='multipart/form-Data'>
                                            <div class='row '>
                                            <div class='form-group col-md-6'>
                                                    <input type='text' class='form-control'
                                                        placeholder='Numero Producto' name='IdProducto'>
                                                </div>
                                                <div class='form-group col-md-6'>
                                                    <input type='text' class='form-control'
                                                ...
                                                <h6 class='col-md-12' style='text-align: center;'>imagenes del producto
                                                </h6>
                                                <div class='form-group col-md-6'>
