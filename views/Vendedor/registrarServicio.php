            ...
            <div class='container-fluid'>
                ...
                <section id='main-content'>
                                ...
                                <div class='card-body'>
                                    <div class='basic-elements'>
                                        <form class='text-left clearfix'
                                            action='../../controllers/registrarServiciosVendedor.php' method='POST'
                                            enctype='multipart/form-Data'>
                                            <div class='row '>
                                            <div class='form-group col-md-6'>
                                                    <input type='text' class='form-control'
                                                        placeholder='Numero de servicio' name='IdServicio'>
                                                </div>
                                                <div class='form-group col-md-6'>
                                                    <input type='text' class='form-control'
                                                ...
                                                <div class="col-md-12">
                                                    <textarea name="descripcion" id="" cols="141"  placeholder="Descripcion del servicio" rows="3" style="resize:none;"></textarea>
                                                </div>
                                               

                                                <h6 class='col-md-12' style='text-align: center;'>imagenes del servicio
                                                </h6>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'>
                            <div class='footer'>
                                <p>2018 © Admin Board. - <a href='#'>Motorsweb</a></p>
                            </div>
                        </div>
                    </div>
                </section>
